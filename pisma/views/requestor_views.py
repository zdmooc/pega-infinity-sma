...
def requestor_action(request: HttpRequest, node_id: str, real_node_id: str, requestor_id: str):
    ...
    try:
        ...
        logger.info('[requestor_action] requestor {} was {}ed'.format(requestor_id, action), request=request)
        messages.success(request, status)
    except Exception as e:
        logger.warning('[requestor_action] view execution exception: "{}"'.format(e), request=request)
