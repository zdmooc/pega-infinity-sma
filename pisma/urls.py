...
urlpatterns = [
    ...
    path('node/<int:node_id>/requestor_action/<str:real_node_id>/<str:requestor_id>/', views.requestor_action, name='requestor_action'),
    ...
    path('node/<int:node_id>/agent_action/<str:real_node_id>/<str:agent_id>', views.agent_action, name='agent_action'),
]
